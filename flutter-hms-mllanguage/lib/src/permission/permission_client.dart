...
enum LanguagePermission { audio, storage }

class PermissionClient {
  late MethodChannel _channel;

  PermissionClient() {
    _channel = const MethodChannel('hms_lang_permissions');
  }

  Future<bool> requestPermission(List<LanguagePermission> permissions) async {
  ...
  Future<bool> hasAudioPermission() async {
    return await _channel.invokeMethod("hasAudioPermission");
  }
