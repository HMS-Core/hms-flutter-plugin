...
public class HandMethodHandler implements MethodChannel.MethodCallHandler, IAnalyzer {
    ...
    public void aFrame(MethodCall mCallHand) {
        ...
        handAnalyzer = MLHandKeypointAnalyzerFactory.getInstance().getHandKeypointAnalyzer(RequestBuilder.createHandAnalyzerSetting(mCallHand));
    ...
    public void asyncAFrame(MethodCall call) {
        ...
        handAnalyzer = MLHandKeypointAnalyzerFactory.getInstance().getHandKeypointAnalyzer(RequestBuilder.createHandAnalyzerSetting(call));
