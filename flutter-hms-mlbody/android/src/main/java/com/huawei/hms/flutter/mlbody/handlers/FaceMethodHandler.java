...
public class FaceMethodHandler implements MethodChannel.MethodCallHandler, IAnalyzer {
    ...
    public void aFrame(MethodCall methodCall) {
        ...
        mlFaceAnalyzer = MLAnalyzerFactory.getInstance().getFaceAnalyzer(RequestBuilder.createFaceAnalyzerSetting(methodCall));
    ...
    public void asyncAFrame(MethodCall call) {
        ...
        mlFaceAnalyzer = MLAnalyzerFactory.getInstance().getFaceAnalyzer(RequestBuilder.createFaceAnalyzerSetting(call));
