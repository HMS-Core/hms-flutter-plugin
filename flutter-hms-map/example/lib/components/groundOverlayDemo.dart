...
class GroundOverlayDemo extends StatefulWidget {
  @override
  _GroundOverlayDemoState createState() => _GroundOverlayDemoState();
}
...
class _GroundOverlayDemoState extends State<GroundOverlayDemo> {
  ...
  final Set<GroundOverlay> _groundOverlays = Set();

  LatLng position = LatLng(41.034721, 28.984627);
  LatLng position2 = LatLng(40.993402, 29.021878);

  GroundOverlay groundOverlay0;
  GroundOverlay groundOverlay1;

  BitmapDescriptor _grounOverlayIcon;
  ...
  void _addGroundOverlays() {
    groundOverlay0 = GroundOverlay(
      groundOverlayId: GroundOverlayId("go_1"),
    ...
    groundOverlay1 = GroundOverlay(
      groundOverlayId: GroundOverlayId("go_2"),
      imageDescriptor: _grounOverlayIcon,
      position: position2,
      width: 1500,
      height: 1500,
