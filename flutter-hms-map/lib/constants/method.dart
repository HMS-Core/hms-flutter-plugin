...
class Method {
  ...
  static const String CameraMoveEnd = "[Camera]onIdle";
  ...
  static const String MapIsCompassEnabled = "[Map]isCompassEnabled";
  static const String MapIsMapToolbarEnabled = "[Map]isMapToolbarEnabled";
  static const String MapGetMinMaxZoomLevels = "[Map]getMinMaxZoomLevels";
  static const String MapIsZoomGesturesEnabled = "[Map]isZoomGesturesEnabled";
  static const String MapIsZoomControlsEnabled = "[Map]isZoomControlsEnabled";
  static const String MapIsScrollGesturesEnabled =
      "[Map]isScrollGesturesEnabled";
  static const String MapIsTiltGesturesEnabled = "[Map]isTiltGesturesEnabled";
  static const String MapIsRotateGesturesEnabled =
      "[Map]isRotateGesturesEnabled";
  static const String MapIsMyLocationButtonEnabled =
      "[Map]isMyLocationButtonEnabled";
  static const String MapIsTrafficEnabled = "[Map]isTrafficEnabled";
  static const String MapIsBuildingsEnabled = "[Map]isBuildingsEnabled";
