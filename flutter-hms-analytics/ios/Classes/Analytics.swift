...
class Analytics: NSObject, Handling{
  ...
  /// - Returns: Void
func config(_ resolve: @escaping FlutterResult) -> Void {
    Log.debug(#function) {
      viewModel.config()
  ...
  /// - Returns: Void
  func setReportPolicies(_ reportPolicyType: NSDictionary, resolve: @escaping FlutterResult) -> Void {
    Log.debug(#function) {
  ...
  ///   - resolve: Refers to result value, in the success scenarario, {"isSuccess": true} is returned. in the failure scenarario, exception is returned.
  /// - Returns: Void
  func onEvent(_ eventId: String, params: NSDictionary, resolve: @escaping FlutterResult) -> Void {
    Log.debug(#function) {
  ...
  ///   - resolve: Refers to result value, in the success scenarario, {"isSuccess": true} is returned. in the failure scenarario, exception is returned.
  /// - Returns: Void
  func setUserProfile(_ name: String, value: String, resolve: @escaping FlutterResult) -> Void {
    Log.debug(#function) {
 ...
 func userProfiles(_ predefined: Bool, resolve: @escaping FlutterResult) -> Void {
    Log.debug(#function) {
  ...
  ///   - resolve: Refers to result value, in the success scenarario, {"isSuccess": true} is returned. in the failure scenarario, exception is returned.
  /// - Returns: Void
  func setAnalyticsEnabled(_ enabled: Bool, resolve: @escaping FlutterResult) -> Void {
    Log.debug(#function) {
  ...
  ///   - resolve: Refers to result value, in the success scenarario, {"isSuccess": true} is returned. in the failure scenarario, exception is returned.
  /// - Returns: Void
func aaid(_ resolve: FlutterResult) -> Void {
    Log.debug(#function) {
  ...
  /// - Returns: Void
 func setUserId(_ userId: String, resolve: @escaping FlutterResult)  -> Void {
    Log.debug(#function) {
  ...
  /// - Returns: Void
 func setSessionDuration(_ milliseconds: Int, resolve: @escaping FlutterResult)  -> Void {
    Log.debug(#function) {
  ...
  ///  - resolve: Refers to result value, in the success scenarario, {"isSuccess": true} is returned. in the failure scenarario, exception is returned.
  /// - Returns: Void
func clearCachedData(_ resolve: @escaping FlutterResult)  -> Void {
    Log.debug(#function) {
