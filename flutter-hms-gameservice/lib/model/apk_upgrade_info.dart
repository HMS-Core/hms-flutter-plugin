...
class ApkUpgradeInfo {
  ...
  factory ApkUpgradeInfo.fromMap(Map<String, dynamic> map) {
  ...
  @override
  String toString() {
    return 'ApkUpgradeInfo(name: $name, id: $id, releaseDate: $releaseDate, versionCode: $versionCode, package: $package, icon: $icon, downUrl: $downUrl, size: $size, diffSize: $diffSize, version: $version, isSignatureDifferent: $isSignatureDifferent, newFeatures: $newFeatures, releaseDateDesc: $releaseDateDesc, detailId: $detailId, isCompulsoryUpdate: $isCompulsoryUpdate, devType: $devType, oldVersionName: $oldVersionName, oldVersionCode: $oldVersionCode, notRcmReason: $notRcmReason, sha256: $sha256)';
  }
}
