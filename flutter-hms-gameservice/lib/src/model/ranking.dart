...
class Ranking {
  ...
  factory Ranking.fromMap(Map<dynamic, dynamic> map) {
    return Ranking(
      ...
      rankingVariants: map['rankingVariants'] != null
          ? List<RankingVariant>.from(
              map['rankingVariants'].map(
                (dynamic e) => RankingVariant.fromMap(e),
              ),
            )
          : null,
    );
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rankingVariants': rankingVariants
          ?.map((RankingVariant rankingVariant) => rankingVariant.toMap())
          .toList(),
    };
  }
