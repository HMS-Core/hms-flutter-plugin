...
class HistoryVersions {
  ...
  Future<bool> delete(HistoryVersionsRequest request) async {
    return await _channel.invokeMethod(
        "HistoryVersions#Delete", request.toJson());
  }
  ...
  Future<HistoryVersion> getHistoryVersion(
      HistoryVersionsRequest request) async {
    final String result =
  ...
  Future<ExecuteResponse> getContent(HistoryVersionsRequest request) async {
    return ExecuteResponse.fromJson(await _channel.invokeMethod(
        "HistoryVersions#ExecuteContent", request.toJson()));
  }
  ...
  Future<Int8List> getContentAsInputStream(
    ...
    return Int8List.fromList(await _channel.invokeMethod(
        "HistoryVersions#ExecuteContentAsInputStream", request.toJson()));
  }
  ...
  Future<bool> getContentAndDownloadTo(
      HistoryVersionsRequest request, String path) async {
    return await _channel
        .invokeMethod("HistoryVersions#ExecuteContentAndDownloadTo", {
  ...
  Future<HistoryVersion> update(HistoryVersionsRequest request) async {
    final String result =
        await _channel.invokeMethod("HistoryVersions#Update", {
      "requestOptions": request.toJson(),
