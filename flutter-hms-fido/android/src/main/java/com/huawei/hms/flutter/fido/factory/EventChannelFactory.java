...
public class EventChannelFactory {
    private static final String TAG = EventChannelFactory.class.getSimpleName();
    ...
    public static void destroy() {
        for (int i = 0; i < allEventChannels.size(); i++) {
            EventChannel eventChannel = allEventChannels.get(i);
            if (eventChannel != null) {
                eventChannel.setStreamHandler(null);
            }
        }
        allEventChannels.clear();
    }
}
