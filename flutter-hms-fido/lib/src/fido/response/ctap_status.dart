...
class CtapStatus {
  ...
  /// Verify that relevant registration or authentication parameters are correct.
  ...
  /// The continuation command, such as authenticatorGetNextAssertion, is not allowed.
  /// Verify that the authenticator is correctly used.
  ...
  /// The authenticator cannot process the request due to the memory usage restriction.
  /// Verify that the authenticator is correctly used.
