...
/// Contains all APIs of HUAWEI IAP.
class IapClient {
  ...
  /// Checks whether the currently signed-in HUAWEI ID is located in a country
  /// or region where HUAWEI IAP is available.
  ...
  /// Checks whether the signed-in HUAWEI ID and the app version meet the
  /// requirements of the sandbox testing.
  ...
  /// Displays the subscription editing screen or subscription management
  /// screen of HUAWEI IAP.
  ...
  /// Creates orders for products managed by the product management system (PMS),
  /// including consumables, non-consumables, and subscriptions.
  ...
  /// Obtains the purchase information of all consumed products or the
  /// receipts of all subscriptions.
  ...
  /// analytics of HUAWEI IAP SDK's methods to improve the service quality.
