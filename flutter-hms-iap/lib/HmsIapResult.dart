...
class HmsIapResult {
  ...
  const HmsIapResult({required this.resultCode, this.resultMessage});
}
...
class HmsIapResults {
  ...
  static const HmsIapResult ACTIVITY_RESULT = HmsIapResult(
      resultCode: "ACTIVITY_RESULT_ERROR", resultMessage: "Result is not OK.");
  static const HmsIapResult IS_SANDBOX_READY_ERROR =
      HmsIapResult(resultCode: "IS_SANDBOX_READY_ERROR", resultMessage: null);
  static const HmsIapResult OBTAIN_PRODUCT_INFO_ERROR = HmsIapResult(
      resultCode: "OBTAIN_PRODUCT_INFO_ERROR", resultMessage: null);
  static const HmsIapResult PURCHASE_INTENT_EXCEPTION = HmsIapResult(
      resultCode: "PURCHASE_INTENT_EXCEPTION", resultMessage: null);
  static const HmsIapResult CONSUME_OWNED_PURCHASE_ERROR = HmsIapResult(
      resultCode: "CONSUME_OWNED_PURCHASE_ERROR", resultMessage: null);
  static const HmsIapResult OBTAIN_OWNED_PURCHASES_ERROR = HmsIapResult(
      resultCode: "OBTAIN_OWNED_PURCHASES_ERROR", resultMessage: null);
  static const HmsIapResult START_IAP_ACTIVITY_ERROR =
      HmsIapResult(resultCode: "START_IAP_ACTIVITY_ERROR", resultMessage: null);
  static const HmsIapResult PURCHASE_INTENT_RESOLUTION = HmsIapResult(
      resultCode: "PURCHASE_INTENT_RESOLUTION_ERROR", resultMessage: null);
  ...
  static const HmsIapResult ORDER_STATE_FAILED = const HmsIapResult(
      resultCode: "-1", resultMessage: "Common failure result code.");
  static const HmsIapResult ORDER_STATE_CANCEL = const HmsIapResult(
      resultCode: "60000", resultMessage: "The user cancels the payment.");
  ...
  static const HmsIapResult ORDER_NOT_ACCEPT_AGREEMENT = const HmsIapResult(
      resultCode: "60055", resultMessage: "Agreement error.");
  static const HmsIapResult ORDER_HIGH_RISK_OPERATIONS = const HmsIapResult(
      resultCode: "60056", resultMessage: "User triggers risk control.");
}
